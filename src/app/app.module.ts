...
import { ForecastColorsDirective } from './directives/forecast-colors.directive';
import { SolarColorsDirective } from './directives/solar-colors.directive';
...
@NgModule({
  declarations: [
    ...
    ForecastColorsDirective,
    SolarColorsDirective
  ],
  imports: [
    BrowserModule,
    HttpClientModule,
